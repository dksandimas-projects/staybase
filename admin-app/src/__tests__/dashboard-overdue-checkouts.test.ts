...
import { getDaysOverdue, selectOverdueCheckouts } from "../pages/DashboardPage";
...
describe("Dashboard overdue check-outs", () => {
  it("surfaces only checked-in bookings whose check-out date is before today", () => {
    ...
    expect(selectOverdueCheckouts([overdue, todayDeparture, futureDeparture, alreadyCheckedOut], todayKey))
      .toEqual([overdue]);
  });
