...
- Booking status transitions: `docs/BACKEND.md §bookings`
- Status badge colors: `docs/FRONTEND.md §Status Badge Colors`
- Housekeeping status field: `docs/BACKEND.md §rooms`
- Intercom unread: `features/INTERCOM-INBOX.md`
- Payment confirmation email: `features/EMAIL-PDF-STORAGE.md`
