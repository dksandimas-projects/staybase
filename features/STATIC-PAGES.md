...
- See `docs/SECURITY.md` for minimum required content
...
- Corporate inquiry pipeline (admin side): `features/CORPORATE-INQUIRIES.md`
- Website content editing: `features/SETTINGS.md §Website Content`
- Contact info source: `docs/BACKEND.md §settings/hotelConfig`
- Corporate booking flow: `features/CORPORATE-BOOKING.md`
