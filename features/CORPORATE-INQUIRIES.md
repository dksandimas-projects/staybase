...
- Inquiry schema: `docs/BACKEND.md §corporateInquiries`
- Corporate booking guest flow: `features/CORPORATE-BOOKING.md`
- Corporate inquiry form (guest side): `features/STATIC-PAGES.md §Corporate Stays`
- New corporate inquiry email: `features/EMAIL-PDF-STORAGE.md`
