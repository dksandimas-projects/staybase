...
- Voucher schema: `docs/BACKEND.md §vouchers`
- Validation API: `docs/API-ROUTES.md §validate`
- Booking flow redemption step: `features/BOOKING-FLOW.md §Step 3`
- Settings page location: `features/SETTINGS.md §Vouchers`
