# Booking Flow
> App: guest-app
> Requires: CLAUDE.md, docs/FRONTEND.md, docs/BACKEND.md, docs/API-ROUTES.md, docs/TYPES.md, guest-app/CLAUDE.md
...
### Data & Logic Checklist
- [ ] Booking creation via `/api/bookings/create` using Firestore transaction — see `features/AVAILABILITY-LOCKING.md`
...
- Availability locking implementation: `features/AVAILABILITY-LOCKING.md`
- Corporate booking variations: `features/CORPORATE-BOOKING.md`
- Voucher validation: `features/VOUCHERS.md`
- Booking schema: `docs/BACKEND.md §bookings`
