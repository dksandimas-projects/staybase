...
- [ ] Availability badge — color-coded per `docs/FRONTEND.md §Status Badge Colors` (Available green, Occupied red, Blocked gray)
...
- Room type definitions and schema: `docs/BACKEND.md §rooms`
- Booking flow entry: `features/BOOKING-FLOW.md`
- Room photo management: `features/ROOM-MANAGEMENT.md`
