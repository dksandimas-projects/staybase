...
> Requires: CLAUDE.md, docs/FRONTEND.md, docs/BACKEND.md, docs/API-ROUTES.md, guest-app/CLAUDE.md
...
- Guest auth vs admin auth: `features/AUTH-ROLES.md`
- Booking linkage: `docs/BACKEND.md §members`
- Post-booking prompt: `features/BOOKING-FLOW.md §Step 4`
- Rewards signup page: `features/STATIC-PAGES.md §Spark Rewards`
- RA 10173 erasure rights: `docs/SECURITY.md §Data Subject Rights`
- Member types: `docs/TYPES.md §Member`
