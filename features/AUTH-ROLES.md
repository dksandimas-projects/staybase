# Auth & Roles
> App: admin-app
> Requires: CLAUDE.md, docs/BACKEND.md, admin-app/CLAUDE.md
...
- Firebase Auth setup: `docs/BACKEND.md §Firebase SDK Usage`
- Role-based rendering: `admin-app/CLAUDE.md §Role-Based Access`
- API route auth verification: `docs/API-ROUTES.md §Authentication`
