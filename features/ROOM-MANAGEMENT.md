...
- Room schema: `docs/BACKEND.md §rooms`
- Firebase Storage upload pattern: `docs/BACKEND.md §Firebase SDK Usage`
- Storage CORS requirement: `docs/GOTCHAS.md`
- Rate management (prices): `features/RATE-MANAGEMENT.md`
- Room status on dashboard grid: `features/DASHBOARD-OVERVIEW.md`
