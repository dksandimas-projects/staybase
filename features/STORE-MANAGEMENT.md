...
- Guest store ordering: `features/STORE-GUEST.md`
- Store schema: `docs/BACKEND.md §storeItems`, `docs/BACKEND.md §storeOrders`
- Store settings: `features/SETTINGS.md §Store`
- Reports page: `features/REPORTS.md`
- Intercom order notification: `features/INTERCOM-INBOX.md`
- Booking bill integration: `features/BOOKINGS-MANAGEMENT.md`
