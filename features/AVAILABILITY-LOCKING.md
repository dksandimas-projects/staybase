...
- Booking creation API route: `docs/API-ROUTES.md §bookings`
- Booking schema: `docs/BACKEND.md §bookings`
- Firestore transaction pattern: `docs/GOTCHAS.md §Firebase`
- Booking flow (guest): `features/BOOKING-FLOW.md`
- Walk-in booking creation: `features/BOOKINGS-MANAGEMENT.md`
