...
**PDF checklist:**
- [ ] Apollo and Inter fonts embedded as base64 — see `docs/GOTCHAS.md §jsPDF`
...
- [ ] Firebase Storage CORS must be configured — see `docs/GOTCHAS.md`
...
- Storage CORS gotcha: `docs/GOTCHAS.md §Firebase`
- Font embedding gotcha: `docs/GOTCHAS.md §jsPDF`
- Receipt trigger in admin: `features/BOOKINGS-MANAGEMENT.md`
- Payment proof upload in guest flow: `features/BOOKING-FLOW.md §Step 3`
