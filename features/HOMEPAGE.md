# Homepage
> App: guest-app
> Requires: CLAUDE.md, docs/FRONTEND.md, guest-app/CLAUDE.md
...
- [ ] 3 featured room cards — pulled from `settings/websiteContent.homepage.featuredRoomIds` — image, name, key amenities, price per night, Book Now CTA
...
- Room card layout: `features/ROOMS-PAGE.md`
- Footer and Navbar: `guest-app/CLAUDE.md`
- Featured room + amenity content editing: `features/SETTINGS.md §Website Content`
- Design tokens: `docs/FRONTEND.md`
