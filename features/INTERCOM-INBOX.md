...
- Store order management: `features/STORE-MANAGEMENT.md`
- Guest intercom counterpart: `features/INTERCOM-GUEST.md`
- Intercom schema: `docs/BACKEND.md §intercoms`
- Notification sound configuration: `features/SETTINGS.md §Intercom`
- Quick request configuration: `features/SETTINGS.md §Intercom`
- Unread count on dashboard: `features/DASHBOARD-OVERVIEW.md`
