...
|---|---|
| Guest UI task | `FRONTEND.md` + `plan/guest-app/CLAUDE.md` + relevant feature MD |
| Admin UI task | `FRONTEND.md` + `plan/admin-app/CLAUDE.md` + relevant feature MD |
...
2. `plan/docs/` — FRONTEND, BACKEND, API-ROUTES, TYPES, ENV-SETUP, FILE-STRUCTURE, DECISIONS, GOTCHAS, CONTRIBUTING
3. App CLAUDEs — `plan/guest-app/CLAUDE.md`, `plan/admin-app/CLAUDE.md`
4. `plan/features/` — guest first (7), then admin (11), then cross-cutting (2)
