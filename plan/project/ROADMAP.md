...
### Multi-Booking Picker (MBP) — shipped 2026-07-24
> Decision #123. Spec: `plan/features/BOOKING-LOOKUP.md §Multi-Booking Picker`. Privacy-preserving list when email-alone path matches >1 booking. **Shipped 2026-07-24 on `feat/multi-booking-picker`.**
