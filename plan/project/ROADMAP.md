...
> Last updated: July 26, 2026 (marked ECE-02 House rules in booking-confirmed + check-in reminder as shipped; ECE-02 ships in the same commit as this roadmap bump per the on-merge rule)
...
_No CRITICAL/HIGH from Sections 1–2 (highest was MED-1: manual points adjustment is a client-side write, **closed 2026-07-25** by decision #134 — see `plan/features/SPARK-REWARDS.md §Known Issues`; `GOTCHAS.md §Security & PII`)._
