...
| 12 — Enhancements, Multi-Room & CRL | 🔄 Active (MRB-01..06 & CRL-01..05 shipped) | Open MRB-07..15 & CRL-06..09 items (§Phase 12 below) |
...
- ✅ **MRB-06 + MRB-07 — guest room cart and admin multi-room New Booking modal** — both shipped 2026-08-02: a guest can cart several rooms into one reservation on `/book`, and the desk can build a mixed-type multi-room reservation from the admin modal, with the Bookings list rendering reservation rows over nested room stays. Full specs in [`plan/project/archive/ROADMAP-SHIPPED-2026-08-02.md`](archive/ROADMAP-SHIPPED-2026-08-02.md).
