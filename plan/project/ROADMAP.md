...
> Last updated: July 9, 2026 (Fix 1 Senior/PWD ID upload repair completed; remaining Phase 12 fixes stay prioritized by effort)
...
| 12 — Post-Launch | 16 | 9 | 4 not started (guest price breakdown, PDF generation repair, check-in gate repair, voucher application repair) + 3 deferred |
