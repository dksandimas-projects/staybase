...
> Last updated: August 2, 2026 (MRB-09 shipped on `feature/phase-12-mrb-09-reservation-scope-emails`; running order — MRB-10 → MRB-13 → CRL-06/07/08/09; previously — MRB-08 shipped at v0.232.0 on `feature/phase-12-mrb-08-corporate-multi-room`).
...
| 12 — Enhancements, Multi-Room & CRL | 🔄 Active (MRB-01..09 & CRL-01..05 shipped) | Open MRB-10..15 & CRL-06..09 items (§Phase 12 below) |
