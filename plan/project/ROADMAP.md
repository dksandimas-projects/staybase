...
> Last updated: July 9, 2026 (Fix 3 check-in gate repair completed; remaining Phase 12 fixes stay prioritized by effort)
...
| 12 — Post-Launch | 16 | 11 | 2 not started (guest price breakdown, PDF generation repair) + 3 deferred |
