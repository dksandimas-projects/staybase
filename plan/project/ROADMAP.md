...
| 12 — Enhancements, Multi-Room & CRL | 🔄 Active (MRB-01..06 & CRL-01..04 implemented) | Open MRB-07..15 & CRL-05..09 items (§Phase 12 below) |
...
### Open Multi-Room Booking (MRB) Tasks (MRB-07..15)
- ✅ **MRB-06 — Guest `/book` flow: quantity per room type** — Implemented 2026-08-02, pending merge. Step 1 has an availability-capped room cart, running aggregate total, and automatic adult/child/extra-bed distribution across room stays. Steps 2–4 retain one lead guest and one reservation payment; confirmation lists every assigned room.
