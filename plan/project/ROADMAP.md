...
- 🔄 **PC-04 — Vercel environment split** — Production/Preview scopes and `stg.`/`stg-admin.` domains configured in Vercel, and **Resend email isolation applied**. Remaining: add `stg.` domains to staging Firebase Auth authorized list & Turnstile allowed domains, and verify staging end-to-end.
