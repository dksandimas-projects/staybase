...
> Verbatim snapshot of `plan/project/context/spark-inn-MASTER-CONTEXT.md` (v2.2, June 7, 2026), archived 2026-07-17 before compaction.
> **Known-stale content:** §14 data model predates W3.6/W3.7 (rate/capacity fields shown on `rooms/{roomId}` moved to `settings/hotelConfig.roomTypes[]` — see GOTCHAS.md), §13 folder structure predates the `guest-app/server/` + committed API bundle layout, §16 timeline is the pre-build estimate.
> Canonical sources: schema `plan/docs/BACKEND.md` · types `plan/docs/TYPES.md` · design `plan/docs/FRONTEND.md` · structure `plan/docs/FILE-STRUCTURE.md` · decisions `plan/docs/DECISIONS-*.md`.
