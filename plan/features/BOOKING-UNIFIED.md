...
- **BAR-03 next** — extract the FOL-05 sibling-flip pass into one `applyReservationScopePaymentTransition` helper called by the three payment handlers. Same low-risk, no-migration shape as BAR-02.
