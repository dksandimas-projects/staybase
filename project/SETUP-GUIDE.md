...
Fill in hotel name, address, contact, check-in/out times, etc. (see `docs/BACKEND.md §settings/hotelConfig` for all fields)
...
See `docs/WHITE-LABEL.md` for the full client deployment checklist.
