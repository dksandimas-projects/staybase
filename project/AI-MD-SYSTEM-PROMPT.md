...
Before building any MD, create two files in a `project/context/` folder:
...
|---|---|
| Frontend UI task | `docs/FRONTEND.md` + `[app]/CLAUDE.md` + relevant feature MD |
| Backend / API task | `docs/BACKEND.md` + `docs/TYPES.md` + `docs/API-ROUTES.md` |
| Full feature build | All of the above + `docs/DECISIONS-FEATURES.md` |
| Security / compliance | `docs/SECURITY.md` + `docs/GOTCHAS.md` |
| New architecture decision | `docs/DECISIONS-ARCH.md` + `docs/GOTCHAS.md` |
...
- After building each major group (docs/, features/, etc.) → check in
