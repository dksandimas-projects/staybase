...
### Authentication
- All staff API routes verify Firebase ID token via Admin SDK — see `docs/API-ROUTES.md §Authentication`
...
See `docs/API-ROUTES.md §Rate Limiting`. Rate limiting is the final layer against brute-force and high-volume attacks that bypass Turnstile.
...
- **Environment variables** containing secrets never committed to git — see `docs/ENV-SETUP.md`
...
See `features/STATIC-PAGES.md §Privacy Policy` for UI implementation.
...
- API authentication: `docs/API-ROUTES.md §Authentication`
- Intercom guest experience: `features/INTERCOM-GUEST.md`
- Privacy Policy page: `features/STATIC-PAGES.md §Privacy Policy`
- Booking consent checkbox: `features/BOOKING-FLOW.md §Step 2`
- PII gotchas: `docs/GOTCHAS.md §Security`
