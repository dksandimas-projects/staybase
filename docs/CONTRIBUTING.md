...
|---|---|
| Architecture/stack/security/white-label decisions | `docs/DECISIONS-ARCH.md` |
| Feature/product/compliance decisions | `docs/DECISIONS-FEATURES.md` |
| Firestore schema (all collections) | `docs/BACKEND.md` |
| TypeScript types | `docs/TYPES.md` |
| Brand tokens, typography, component rules | `docs/FRONTEND.md` |
| Environment variables | `docs/ENV-SETUP.md` |
| Folder structure, naming conventions | `docs/FILE-STRUCTURE.md` |
| "Never do this" rules | `docs/GOTCHAS.md` |
| API route surface | `docs/API-ROUTES.md` |
| Feature UI + logic checklists | Relevant `features/*.md` |
| Master TOC + read bundles + hard rules | `CLAUDE.md` |
| Session bootstrapping context | `project/context/spark-inn-MASTER-CONTEXT.md` |
...
|---|---|
| New architecture/stack decision | `docs/DECISIONS-ARCH.md` + affected feature MD |
| New feature/product decision | `docs/DECISIONS-FEATURES.md` + affected feature MD |
| Schema field added/changed | `docs/BACKEND.md` + `docs/TYPES.md` |
| New TypeScript type | `docs/TYPES.md` only |
| New environment variable | `docs/ENV-SETUP.md` only |
| New API route | `docs/API-ROUTES.md` only |
| New "never do this" rule | `docs/GOTCHAS.md` only |
| Feature scope changed | Relevant `features/*.md` |
| New feature file added | `docs/FILE-STRUCTURE.md` + `CLAUDE.md` TOC |
| New MD file created | `CLAUDE.md` TOC + this file's ownership table |
| Major feature/phase completed | `project/context/spark-inn-MASTER-CONTEXT.md` |
...
3. If a feature MD needs to reference the change, add a one-line reference: "See `docs/BACKEND.md §bookings`"
...
- `docs/update-backend-schema` — documentation only
...
1. Create the file in the appropriate folder (`docs/` or `features/`)
