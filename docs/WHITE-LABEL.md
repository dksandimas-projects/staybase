...
- Config usage in UI: `docs/FRONTEND.md`
- File locations: `docs/FILE-STRUCTURE.md`
- Room type usage in rates: `features/RATE-MANAGEMENT.md`
- Legal content editing: `features/SETTINGS.md §Legal Content`
