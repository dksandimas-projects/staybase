...
|---|---|---|
| `/` | `HomePage.tsx` | `features/HOMEPAGE.md` |
| `/rooms` | `RoomsPage.tsx` | `features/ROOMS-PAGE.md` |
| `/about` | `AboutPage.tsx` | `features/STATIC-PAGES.md` |
| `/corporate` | `CorporatePage.tsx` | `features/STATIC-PAGES.md` |
| `/corporate/book` | `CorporateBookingPage.tsx` | `features/CORPORATE-BOOKING.md` |
| `/contact` | `ContactPage.tsx` | `features/STATIC-PAGES.md` |
| `/book` | `BookingPage.tsx` | `features/BOOKING-FLOW.md` |
| `/book/confirm` | `BookingConfirmPage.tsx` | `features/BOOKING-FLOW.md` |
| `/my-booking` | `BookingLookupPage.tsx` | `features/BOOKING-LOOKUP.md` |
| `/intercom/:roomId` | `IntercomPage.tsx` | `features/INTERCOM-GUEST.md` |
| `/privacy` | `PrivacyPage.tsx` | `features/STATIC-PAGES.md` |
| `/rewards` | `RewardsPage.tsx` | `features/SPARK-REWARDS.md` |
| `/signin` | `SignInPage.tsx` | `features/SPARK-REWARDS.md` |
| `/signup` | `SignUpPage.tsx` | `features/SPARK-REWARDS.md` |
| `/account/profile` | `ProfilePage.tsx` | `features/SPARK-REWARDS.md` |
| `/account/stays` | `StaysPage.tsx` | `features/SPARK-REWARDS.md` |
| `/account/rewards` | `RewardsPortalPage.tsx` | `features/SPARK-REWARDS.md` |
| `*` | `NotFoundPage.tsx` | `features/STATIC-PAGES.md` |
...
See `features/BOOKING-FLOW.md` for full checklist.
...
See `features/CORPORATE-BOOKING.md`.
